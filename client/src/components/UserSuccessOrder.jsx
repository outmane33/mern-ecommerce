    ...
    <div className="min-h-screen flex justify-center items-center bg-[#fbfdfc]">
      <div className="flex flex-col justify-center items-center gap-7 max-w-[900px] w-full">
        ...
        <div className="flex flex-col gap-2 bg-white p-5 rounded-lg max-w-[600px] w-full">
          <p className="text-2xl font-semibold text-[#112428]">Order Summary</p>
          {/* product */}
          <table>
            {orderItems &&
              orderItems.map((item) => (
          ...
          <div className="flex justify-between pt-3">
            <p className="font-semibold text-xl text-[#112428]">Total</p>
            <p className="font-semibold text-xl">{totalPrice} MAD</p>
          </div>
          {/* back home */}
        </div>
        <button
