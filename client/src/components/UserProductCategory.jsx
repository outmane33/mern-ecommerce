...
import { Breadcrumb, Drawer, Dropdown, TextInput } from "flowbite-react";
...
export default function UserProductCategory() {
  ...
  useEffect(() => {
    getAllProducts(
      `/api/v1/product?category=${capitalizeFirstLetter(category)}`
    );
  }, [location.pathname]);

  // Utility function to build the query string
  const buildQueryString = (params) => {
    const { sort, colors, material, keyword } = params;
    const queryParts = [];
  ...
  const updateFiltersAndFetch = (newFormQuery) => {
    ...
    let addCategpry =
      queryString === "/api/v1/product"
        ? `?category=${capitalizeFirstLetter(category)}`
        : `&category=${capitalizeFirstLetter(category)}`;

    getAllProducts(queryString + addCategpry);
  };
  ...
  const handleImageCover = (category) => {
    switch (category) {
      case "Chairs":
        return "https://startersites.io/blocksy/furniture/wp-content/uploads/2024/05/chairs-category-hero-image.webp";
      case "Storage":
        return "https://startersites.io/blocksy/furniture/wp-content/uploads/2024/05/storage-category-hero-image.webp";
      case "Armchairs":
        return "https://startersites.io/blocksy/furniture/wp-content/uploads/2024/05/armchairs-category-hero-image.webp";
      case "Sofas":
        return "https://startersites.io/blocksy/furniture/wp-content/uploads/2024/05/sofas-category-hero-image.webp";
      case "Beds":
        return "https://startersites.io/blocksy/furniture/wp-content/uploads/2024/05/beds-category-hero-image.webp";
      case "Tables":
        return "https://startersites.io/blocksy/furniture/wp-content/uploads/2024/05/tables-category-hero-image.webp";
      case "Decor":
        return "https://startersites.io/blocksy/furniture/wp-content/uploads/2024/05/decor-category-hero-image.webp";
      default:
    ...
    <>
      ...
      <div className="flex justify-center items-center relative mx-5 md:mx-7 lg:mx-9 xl:mx-12">
        <div className="max-w-[1700px] w-full my-16 relative  h-[300px] lg:h-[400px]">
          ...
          {/* Image */}
          <img
            src={handleImageCover(capitalizeFirstLetter(category))}
            alt=""
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-3xl font-bold">
            <p className="pb-6">{capitalizeFirstLetter(category)}</p>
            <Breadcrumb
            ...
            >
              ...
              <Breadcrumb.Item href="#" className="text-white">
                <p className="text-white">{category.toLocaleUpperCase()}</p>
              </Breadcrumb.Item>
            </Breadcrumb>
          </div>
        </div>
